...
<div class="site-container">
    ...
    <div class="main-container">
        ...
        <div class="cart-content">
                ...
                <div id="removeFromCartButton{{ $item->id }}">
                    ...
                    <div class="content-product-info">
                        <div class="content-product-info-price"><span class="content-product-info-price-button">
                                @isset($item->product->manufacturer->currency){{ strrev(chunk_split(strrev($item->product->base_price * (int)$item->product->manufacturer->currency->exchange_rate), 3, ' ')) }} руб.@elseЦена по запросу@endisset
                            </span></div>
            ...
            @endforeach
            <div class="content-product-info">
                <span class="content-product-info-price-button" id="totalPrice">Общая стоимость: {{ strrev(chunk_split(strrev((int)$totalPrice), 3, ' ')) }} руб.</span>
            </div>
            <div class="cart-form">
