                ...
                @foreach($productsCarousel as $product)
                    ...
                    <div class="content-product-info">
                        <div class="content-product-info-price"><span class="content-product-info-price-button">
                                @if(isset($product->manufacturer->currency) && $product->base_price != 0){{ strrev(chunk_split(strrev(round($product->base_price * $product->manufacturer->currency->exchange_rate)), 3, ' ')) }} руб.@elseЦена по запросу@endif
                            </span></div>
